...
//* Exports
//* Note: goog.exportSymbol writes these onto the scope object, which the closure compiler output_wrapper (see scripts/build-validation.js) then exports as the default ES Module export.
goog.exportSymbol("validation", {});
goog.exportSymbol("validation.formatNumberAsYouType", formatNumberAsYouType);
goog.exportSymbol("validation.formatNumber", formatNumber);
goog.exportSymbol("validation.getExampleNumber", getExampleNumber);
goog.exportSymbol("validation.getExtension", getExtension);
goog.exportSymbol("validation.getNumberType", getNumberType);
goog.exportSymbol("validation.getValidationError", getValidationError);
goog.exportSymbol("validation.isValidNumber", isValidNumber);
goog.exportSymbol("validation.isPossibleNumber", isPossibleNumber);
goog.exportSymbol("validation.getCoreNumber", getCoreNumber);
//* Enums
goog.exportSymbol("validation.numberFormat", numberFormat);
goog.exportSymbol("validation.numberType", numberType);
goog.exportSymbol("validation.validationError", validationError);
